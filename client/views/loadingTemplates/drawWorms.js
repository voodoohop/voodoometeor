...
Template.loadingtemplate4.rendered = function() {
  if (!app)
    app = new DrawWorm('canvas');
    app.initialize();
  count = 0;
  interval = setInterval( demoApp, 20 );
};

Template.loadingtemplate4.destroyed = function() {
  clearInterval(interval);
}

window.DrawWorm = DrawWorm;