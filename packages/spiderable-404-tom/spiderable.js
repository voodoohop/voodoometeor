...
console.log("initing phantomjs connect handler")
console.log(/\?.*_escaped_fragment_=/.test("/?_escaped_fragment_="))
WebApp.connectHandlers.use(function (req, res, next) {
  console.log(req.url);
  console.log(/\?.*_escaped_fragment_=/.test(req.url));
  if (/\?.*_escaped_fragment_=/.test(req.url)  ||
    ...
    console.log("running phantomjs for url", url);
    ...
    child_process.execFile(
      ...
      function (error, stdout, stderr) {
        console.log("phantomjs result", error, stdout, stderr);
